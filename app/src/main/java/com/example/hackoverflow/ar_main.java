...
public class ar_main extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button rl=findViewById(R.id.rl);
        ...
        resolveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                dialog.setOkListener(ar_main.this::onResolveOkPressed);
    ...
    private void resolveall(int score)
    {
        onResolveAll(score);
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                setCloudAnchor(null);
                Toast.makeText(ar_main.this, "5 sec ends", Toast.LENGTH_SHORT).show();
                //  onResolveAll(score+1);
    ...
    private void onResolveAll(int shortCode){
